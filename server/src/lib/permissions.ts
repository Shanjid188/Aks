...
export const PERMISSION_CATALOG: PermissionModule[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "pos.sale", label: "Create POS Sale" },
      { key: "pos.hold", label: "Hold / Resume Sale" },
      { key: "pos.print", label: "Print Receipt" },
    ],
  },
  {
    module: "orders",
    ...
    permissions: [
      ...
      { key: "orders.details", label: "View Details" },
      { key: "orders.create", label: "Create Order" },
      { key: "orders.edit", label: "Edit Order" },
      { key: "orders.status", label: "Change Status" },
      { key: "orders.cancel", label: "Cancel Order" },
      { key: "orders.delete", label: "Delete Order" },
      { key: "orders.payment", label: "Update Payment" },
      { key: "orders.print", label: "Print Invoice" },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "products.upload", label: "Upload Images" },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "customers.details", label: "View Details" },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "purchases.receive", label: "Receive Purchase" },
      { key: "purchases.print", label: "Print Purchase" },
    ],
  },
  {
    module: "expenses",
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "coupons.create", label: "Create Coupon" },
      { key: "coupons.edit", label: "Edit Coupon" },
      { key: "coupons.delete", label: "Delete Coupon" },
    ],
  },
  {
    module: "reviews",
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "promotions.edit", label: "Edit Promotion" },
  ...
  },
  {
    ...
    icon: "image",
    permissions: [
      { key: "slides.view", label: "View Slides" },
      { key: "slides.create", label: "Create Slide" },
      { key: "slides.edit", label: "Edit Slide" },
      { key: "slides.delete", label: "Delete Slide" },
    ],
  },
  {
    module: "storefront",
    ...
    icon: "store",
    permissions: [
      { key: "storefront.view", label: "View Settings" },
      { key: "storefront.edit", label: "Edit Settings" },
    ],
  },
  {
    module: "invoices",
    ...
    permissions: [
      ...
      { key: "invoices.print", label: "Print Invoice" },
  ...
  },
  {
    ...
    icon: "box",
    permissions: [
      { key: "packaging.view", label: "View Packaging" },
      { key: "packaging.print", label: "Print Slip" },
      { key: "packaging.pack", label: "Mark Packed" },
    ],
  },
  {
    module: "reports",
  ...
  },
  {
    ...
    icon: "rotate-ccw",
    permissions: [
      { key: "refunds.view", label: "View Returns" },
      { key: "refunds.create", label: "Create Return" },
      { key: "refunds.approve", label: "Approve / Reject" },
      { key: "refunds.refund", label: "Process Refund" },
    ],
  },
  {
    module: "shipping",
    ...
    permissions: [
      ...
      { key: "shipping.update", label: "Update Status" },
    ],
  },
  {
    module: "admins",
    ...
    permissions: [
      ...
      { key: "admins.disable", label: "Disable Admin" },
  ...
  },
  {
    ...
    icon: "list",
    permissions: [
      { key: "activity_logs.view", label: "View Logs" },
      { key: "activity_logs.export", label: "Export Logs" },
    ],
  },
];
...
/** The Super Admin role receives every permission - this never changes. */
export const SUPER_ADMIN_PERMISSIONS: string[] = ALL_PERMISSIONS;

/** Convenience lookups used by guards / seed. */
export const PERM = {
